...
function monogram(initials){
  const svg = `<svg xmlns='http://www.w3.org/2000/svg' width='96' height='96'>`
    + `<circle cx='48' cy='48' r='47' fill='%23232017' stroke='%23c9a86a' stroke-opacity='0.45'/>`
    + `<text x='48' y='60' font-family='Georgia, serif' font-size='34' fill='%23c9a86a' text-anchor='middle'>${initials}</text>`
    + `</svg>`;
